...
1. Manage Customers -> User Details: (ID,name,age,address,etc) Get Details() Show Details() - .txt file
2. Manage Cabs -> cab choice; kilmeres; cost; Cab Details()
3. Manage Booking -> hotel choice; packages; hotel[];cost; Hotels()
4. Billing -> cab charge; hotel charge; tatal cost; Print Bill() - Txt file show Bill()

----------------------
receipt.txt -> Customer ID, Cost for each item; total charge - (Save above attributes of present customer)

old-customers.txt -> (Save all details & customers who used the system)

---------------------
Manage system main menu -> system username; - Manage Menu() - Manage Menu() - Main Menu()
...
public:
    ...
    void cabDetails()
    {
        ...
        cout << "-----------ABC Cabs-----------\n" << endl;
        cout << "1. Rent a Standard Cab - BDT.30 for 1KM" << endl;
        cout << "2. Rent a Luxury Cab - BDT.50 per 1KM" << endl;
        ...
        if(cabChoice == 1){
            ...
            cout << "\nYour tour will cost " << cabCost << " BDT. for a standard cab" << endl;
            ...
            cabCost = kilometers * 50;
            cout << "\nYour tour will cost " << cabCost << " BDT. for a luxury cab" << endl;
            cout << "Press 1 to hire this cab: or ";
            cout << "Press 2 to select another cab: ";
            cin >> hireCab;
            system("CLS");
...
public:
    ...
    void hotels()
    {
        ...
        if(choiceHotel == 1){
            ...
            cout << "\tAll basic facilities you need just for: BDT.5000.00" << endl;
            cout << "2. Premium Pack" << endl;
            cout << "\tEnjoy Premium: BDT.10000.00" << endl;
            cout << "3. Luxury Pack" << endl;
            cout << "\tLive a Luxury at Avendra: BDT.15000.00" << endl;
            ...
            cout << "\t BDT.15000.00 for a day" << endl;
            cout << "2. Couple Pack" << endl;
            cout << "\t BDT.10000.00 for a day" << endl;
            ...
            cout << "Amazing offer in this summer: BDT.5000.00 for a one day!!!" << endl;
